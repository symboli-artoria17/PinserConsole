...
<%@ include file="header.jsp" %>
    ...
    <div class="container" style="padding-bottom: 100px;">
		...
		<div class="col-md-12 col-lg-5">
			  ...
			  <label class="add-on" style="font-family: Eras ITC, Eras Light ITC,  sans-serif; color:#16B7A1; font-size:16px;"><strong> User ID: </strong></label>
			  <label class="add-on" style="font-family: Eras ITC, Eras Light ITC,  sans-serif; color:#889493; font-size:16px;"> ${UP.uid} </label>
              <br>
			  <label class="add-on" style="font-family: Eras ITC, Eras Light ITC,  sans-serif; color:#16B7A1;vertical-align: top;height:20px;font-size:16px;"><strong>User Description:</strong></label>
		  ...
		  <div class="col-md-12 col-lg-5 col-lg-offset-1">
			  <label class="add-on" style="font-family: Eras ITC, Eras Light ITC,  sans-serif; color:#16B7A1;  font-size:16px;"><strong> User Score: </strong></label>
			  <label class="add-on" style="font-family: Eras ITC, Eras Light ITC,  sans-serif; color:#889493;  font-size:16px;"> N/A </label>
              <br>
	  ...
	  <p class="add-on" style="font-family: Eras ITC, Eras Light ITC,  sans-serif; color:#16B7A1; background-color:white;
           font-size:22px; padding-top: 40px; padding-bottom: 20px;"><strong>User Stats</strong></p>
	<div class="table-responsive">
            <table id="dataTable" class="table table-striped dataTable homeTable">
              ...
              <tbody style="font-family: Eras ITC, Eras Light ITC,  sans-serif; color:#16B7A1; font-size:16px;">
                ...
                <tr>
                  <td><a href="videoController?action=video&&videoid=${uservideo.videoID}">${uservideo.videoID}</a></td>
                  <td>${uservideo.caption}</td>
				  <td>${uservideo.voteCount}</td>
				  <td>${uservideo.location}</td>
          ...
          <p class="add-on" style="font-family: Eras ITC, Eras Light ITC,  sans-serif; color:#16B7A1; background-color:white;
           font-size:22px; padding-top: 50px; padding-bottom: 20px;"><strong>User Comments</strong></p>
          <div class="table-responsive">
            <table id="studentTable" class="table table-striped dataTable homeTable">
              ...
              <tbody style="font-family: Eras ITC, Eras Light ITC,  sans-serif; color:#16B7A1; font-size:16px;">
                ...
                <tr>
                  <td><a href="videoController?action=video&&videoid=${uservideocomment.videoId}">${uservideocomment.videoId}</a></td>
